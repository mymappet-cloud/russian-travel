...
- The easiest way to run a project is download zip
  from [https://github.com/mymappet-cloud/russian-travel/archive/refs/heads/main.zip](https://github.com/mymappet-cloud/russian-travel/archive/refs/heads/main.zip)
- Or you can use the command

```sh
git clone https://github.com/mymappet-cloud/russian-travel.git
```
